...
# First pass used the 99.5th percentile of normal scores as the alert threshold — sounded
...
# above it before the failure hits. Swept 90th-99.5th percentile against the held-out set;
